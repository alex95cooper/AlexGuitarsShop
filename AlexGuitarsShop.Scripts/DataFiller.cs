...
public static class DataFiller
{
    ...
    public async static Task<Guitar[]> GetGuitarsAsync()
    {
        ...
        return new Guitar[]
        {
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "gibson-57-les-paul-goldtop.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                functionality.",
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "gibson-es-335-figured-sixties-cherry.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "gibson-explorer-70s-classic-white.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "gibson-sg-standard-heritage-cherry.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "gibson-firebird-custom-natural.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "fender-american-pro-telecaster.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "fender-noventa-jazzmaster.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "fender-player-stratocaster.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ibanez-rg5121-bcf.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ibanez-rg370ahmz-bmt.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ibanez-rgms8-bk.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ibanez-rg8520sltd-ntf.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ibanez-rg421-mol.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "mayones-regius-6-gothic.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "mayones-regius-pro-6-gothic.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "cort-kx507-multi-scale.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "cort-cr250.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "cort-kx-5.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "cort-x-2.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "cort-x-5.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "bc-rich-warlock-mk1.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "bc-rich-warbeast.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "bc-rich-ironbird-mk2.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "bc-rich-mockinbird.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "bc-rich-bich.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "jackson-js32t-kelly.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "jackson-rr3-roads.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image = $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "esp-e-2-arrow.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "esp-e-2-eclipse-ft.jpg"))}",
                IsDeleted = 0
            },
            new()
            {
                ...
                Image =
                    $"{await ImageConverter.GetBase64StringAsync(Path.Combine(filepath, "ltd_f-200_black_satin.jpg"))}",
                IsDeleted = 0
            }
        };
    }
