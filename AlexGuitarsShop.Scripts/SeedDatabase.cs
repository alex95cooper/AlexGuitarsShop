...
public static class SeedDatabase
{
    ...
    private static void FillGuitars(IDbConnection db)
    {
        ...
        ('GIBSON 57 LES PAUL GOLDTOP', 5000, 
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\gibson-57-les-paul-goldtop.jpg'), 0),
        ('GIBSON ES-335 Figured Sixties Cherry', 3000, 
         ...
         functionality.',
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\gibson-es-335-figured-sixties-cherry.jpg'), 0),
        ('GIBSON EXPLORER 70s CLASSIC White', 1500, 
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\gibson-explorer-70s-classic-white.jpg'), 0),
        ('Gibson SG Standard Heritage Cherry', 1000,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\gibson-sg-standard-heritage-cherry.jpg'), 0),
        ('GIBSON FIREBIRD CUSTOM Natural', 1200,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\gibson-firebird-custom-natural.jpg'), 0),
        ('FENDER AMERICAN PRO II TELECASTER', 1400,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\fender-american-pro-telecaster.jpg'), 0),
        ('FENDER NOVENTA JAZZMASTER', 1100,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\fender-noventa-jazzmaster.jpg'), 0),
        ('Fender Player Stratocaster', 1000,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\fender-player-stratocaster.jpg'), 0),
        ('IBANEZ RG5121 BCF', 1250,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ibanez-rg5121-bcf.jpg'), 0),
        ('IBANEZ RG370AHMZ BMT', 800,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ibanez-rg370ahmz-bmt.jpg'), 0),
        ('IBANEZ RGMS8-BK', 800,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ibanez-rgms8-bk.jpg'), 0),
        ('IBANEZ RG8520SLTD NTF', 900,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ibanez-rg8520sltd-ntf.jpg'), 0),
        ('IBANEZ RG421 MOL', 380,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ibanez-rg421-mol.jpg'), 0),
        ('Mayones Regius 6 Gothic', 2000,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\mayones-regius-6-gothic.jpg'), 0),
        ('Mayones Regius PRO 6', 2500,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\mayones-regius-pro-6-gothic.jpg'), 0),
        ('CORT KX507 Multi Scale', 750,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\cort-kx507-multi-scale.jpg'), 0),
        ('CORT CR250', 400,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\cort-cr250.jpg'), 0),
        ('CORT KX-5', 195,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\cort-kx-5.jpg'), 0),
        ('CORT X-2', 150,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\cort-x-2.jpg'), 0),
        ('CORT X-5', 180,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\cort-x-5.jpg'), 0),
        ('B.C.Rich WARCLOCK MK1', 1750,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\bc-rich-warlock-mk1.jpg'), 0),
        ('B.C.Rich WARBEAST', 1750,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\bc-rich-warbeast.jpg'), 0),
        ('B.C.Rich IRONBIRD MK-2', 2800,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\bc-rich-ironbird-mk2.jpg'), 0),
        ('B.C.Rich MOCKINGBIRD', 1900,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\bc-rich-mockinbird.jpg'), 0),
        ('BC RICH BICH', 3500,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\bc-rich-bich.jpg'), 0),
        ('JACKSON JS32T Kelly', 500,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\jackson-js32t-kelly.jpg'), 0),
        ('JACKSON RR3 RHOADS', 1460,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\jackson-rr3-roads.jpg'), 0),
        ('ESP E-II ARROW', 2370,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\esp-e-2-arrow.jpg'), 0),
        ('ESP E-II ECLIPSE FT', 2400,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\esp-e-2-eclipse-ft.jpg'), 0),
        ('LTD F-200', 700,
         ...
         LOAD_FILE('{currentPath}\\wwwroot\\products_images\\ltd_f-200_black_satin.jpg'), 0);");
    }
