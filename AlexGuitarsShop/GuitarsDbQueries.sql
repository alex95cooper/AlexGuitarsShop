...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\gibson-57-les-paul-goldtop.jpg'), 0),
('GIBSON ES-335 Figured Sixties Cherry', 3000, 
'The GIBSON ES-335 FIGURED SIXTIES CHERRY semi-acoustic guitar is the perfect combination of shape and functionality.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\gibson-es-335-figured-sixties-cherry.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\gibson-explorer-70s-classic-white.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\gibson-sg-standard-heritage-cherry.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\gibson-firebird-custom-natural.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\fender-american-pro-telecaster.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\fender-noventa-jazzmaster.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\fender-player-stratocaster.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ibanez-rg5121-bcf.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ibanez-rg370ahmz-bmt.jpg'), 0),
('IBANEZ RGMS8-BK', 800,
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ibanez-rgms8-bk.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ibanez-rg8520sltd-ntf.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ibanez-rg421-mol.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\mayones-regius-6-gothic.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\mayones-regius-pro-6-gothic.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\cort-kx507-multi-scale.jpg'), 0),
('CORT CR250', 400,
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\cort-cr250.jpg'), 0),
('CORT KX-5', 195,
'The KX Series is for the thoroughly modern player who also appreciates 
 the best of time-tested classic design and features. 
 Double-cutaway design with easy access to the 24-fret neck, 
 the KX models are sonically as powerful as they look.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\cort-kx-5.jpg'), 0),
('CORT X-2', 150,
'Cort X-2 is a versatile model that is ideal for any guitarist, 
 whether it is an experienced person or a completely green beginner. 
 Already with one appearance, the guitar says that it is intended for fans of speed.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\cort-x-2.jpg'), 0),
('CORT X-5', 180,
'X Series electric guitars are designed for speed. 
 Aggressive body contours and a comfortable neck-to-body 
 connection help you play quickly and easily.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\cort-x-5.jpg'), 0),
('B.C.Rich WARCLOCK MK1', 1750,
'The B.C. Rich Warlock 7 String Electric Guitar features hard tail construction 
 with a satin natural painted neck for an easy, speedy feel. With fretwork and 
 Playability unrivaled at their price point, the Mk1 Series bring an amazing 
 level of quality to the entry level player.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\bc-rich-warlock-mk1.jpg'), 0),
('B.C.Rich WARBEAST', 1750,
'B.C. Rich guitars always stuck out of the crowd for their uniqueness and innovative solutions. 
 With a body that combines the Warlock and Beast shapes, the Warbeast is an epically B.C. Rich style guitar.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\bc-rich-warbeast.jpg'), 0),
('B.C.Rich IRONBIRD MK-2', 2800,
'B.C. Rich guitars always stuck out of the crowd for their uniqueness and innovative solutions. 
 This 50th Anniversary of the company brings another bold push toward the future of modern guitar making.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\bc-rich-ironbird-mk2.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\bc-rich-mockinbird.jpg'), 0),
('BC RICH BICH', 3500,
'This is a well-made unique 10-string guitar for a highly affordable price. 
 ...
 a unique 10-string set up and a super comfortable neck. The guitar is also light-weight adding to its comfort level.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\bc-rich-bich.jpg'), 0),
('JACKSON JS32T Kelly', 500,
'Fast, deadly and affordable, the JACKSON JS32T Kelly AH Viola Burst electric guitar takes a giant leap forward, 
 making the classic Jackson sound, look and play accessible like never before.',
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jackson-js32t-kelly.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jackson-rr3-roads.jpg'), 0),
('ESP E-II ARROW', 2370,
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\esp-e-2-arrow.jpg'), 0),
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\esp-e-2-eclipse-ft.jpg'), 0),
('LTD F-200', 700,
...
LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ltd_f-200_black_satin.jpg'), 0);

ALTER TABLE Guitars
ADD Type VARCHAR(15)
DEFAULT 'Guitar';

SELECT * FROM Guitars WHERE IsDeleted = 0